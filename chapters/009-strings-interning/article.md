...
![Memory: 200,000 discarded strings return to baseline after GC.Collect(), while 200,000 interned strings stay fully resident because the intern pool is itself a permanent GC root](diagrams/png/009-memory.png)
