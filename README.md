...
**Chapters completed:** 12 / 59 (000–011) · 1 in progress (012)
...
| 2 — Memory | 🟡 In progress (7/9 done, 1 in progress) |
| 3 — C# | ⬜ Not started |
...
| 2 — Memory | [005](chapters/005-stack-vs-heap)–[011](chapters/011-gc-generations-loh) done, [012](chapters/012-idisposable-finalizers) in progress, 013 planned | 🚧 In progress |
| 3 — C# | 014–018 | ⏳ Planned |
...
**Written so far:** [000](chapters/000-introduction) Welcome to Inside .NET · [001](chapters/001-execution-flow) Execution Flow · [002](chapters/002-clr) Understanding the CLR · [003](chapters/003-jit-compilation) JIT Compilation Explained · [004](chapters/004-assemblies-metadata) Assemblies, DLLs & Metadata · [005](chapters/005-stack-vs-heap) Stack vs Heap · [006](chapters/006-value-vs-reference-types) Value Types vs Reference Types · [007](chapters/007-object-allocation) Object Allocation · [008](chapters/008-boxing-unboxing) Boxing & Unboxing · [009](chapters/009-strings-interning) Strings & Interning · [010](chapters/010-garbage-collection) Garbage Collection Fundamentals · [011](chapters/011-gc-generations-loh) GC Generations & the Large Object Heap *(009, 010, and 011 are all done — text, code, diagrams, and interim SVG illustrations complete; final externally-sourced illustrations still pending, see [BACKLOG.md](BACKLOG.md))*
